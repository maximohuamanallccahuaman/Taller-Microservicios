...
public class PaymentServiceImpl implements PaymentService{
    ...
    public Payment update(Payment payment) {
        ...
        if (!optionalPayment.isPresent()) throw new RuntimeException("No se encontro la tarjeta a actualizar");
        return paymentRepository.save(payment);
    }
    ...
    public void delete(String id) {
        ...
        if (!optionalPayment.isPresent()) throw new RuntimeException("No se encontro la tarjeta a eliminar");
